...
try {
    ...
    $mail->setFrom('info.icmlda@gmail.com', 'Paper Submission System');
    $mail->addAddress('info.icmlda@gmail.com', 'Paper Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICMLDA Paper Submission - ' . htmlspecialchars($_POST['Paper_Title']);
