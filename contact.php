...
try {
    ...
    $mail->Password   = 'ilfe ggxg efwl ohca'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.icmlda@gmail.com', 'ICMLDA Enquiry');
    $mail->addAddress('info.icmlda@gmail.com', 'ICMLDA Enquiry');
    ...
    $replyMail->Username   = 'info.icmlda@gmail.com';
    $replyMail->Password   = 'ilfe ggxg efwl ohca';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icmlda@gmail.com', 'ICMLDA Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICMLDA 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICMLDA 2025 Team</p>
        </div>
    ';
